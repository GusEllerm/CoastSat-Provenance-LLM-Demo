...
export function hydrate(value: types.Node): types.Node {
  ...
  switch (value.type) {
    ...
    case "Citation":
      return Object.setPrototypeOf(value, types.Citation.prototype);
    case "CitationGroup":
      return Object.setPrototypeOf(value, types.CitationGroup.prototype);
    case "Claim":
    ...
    case "InstructionAttachment":
      return Object.setPrototypeOf(value, types.InstructionAttachment.prototype);
